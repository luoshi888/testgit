...
<table class="layui-table" >
  <thead>
    <tr>
      ...
      <th lay-data="{field:'classify', width:80}">删除</th>
  ...
  <tbody>
  	...
  	<c:forEach var="user" items="${userlist }">
				     ...
				     <td lay-data="{field:'classify', width:80}"><a href="user/Dele_User_Servlet?id=${user.id }" >删除</a></td>
				     <td lay-data="{field:'wealth', width:135, sort: true}"><a href="All_User_Update.jsp?id=${user.id }" >修改</a></td>
	   		   	</tr>
	</c:forEach>
	 </tbody>
</table>
